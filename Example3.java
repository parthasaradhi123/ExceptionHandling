...
class Chai
{
	public void chai() throws ArithmeticException
	{
...
class Cofee
{
	public void cof() throws ArithmeticException
	{
		Chai c = new Chai();
		c.chai();
	}
...
public class Example3 {
	...
	public static void main(String[] args) 
	{
		...
		{
			System.out.println("I am trying to handle the expection in main method instead of beta coffe and chai ::");
		}
	}
}
